...
class TaskFilter(django_filters.FilterSet):
    ...
    from_periodic = django_filters.CharFilter(field_name="from_periodic", )
    from_periodic_null = django_filters.CharFilter(field_name="from_periodic", method='filter_from_periodic_null')
...
class TaskPeriodicFilter(django_filters.FilterSet):
    ...
    periodic_method = django_filters.CharFilter(field_name="crontab", method='filter_periodic_method')
    name = django_filters.CharFilter(field_name="name")
